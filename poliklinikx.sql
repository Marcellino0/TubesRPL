...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2024 at 02:08 PM
...
(1, 1, '08:00:00', '12:00:00', 24, 6, 30, 'Senin', 'Aktif', ''),
(2, 1, '08:00:00', '12:00:00', 10, 10, 20, 'Selasa', 'Aktif', ''),
...
(9, 6, '09:00:00', '11:00:00', 0, 15, 40, 'Jumat', 'Aktif', ''),
...
--
ALTER TABLE `pemeriksaan`
  MODIFY `ID_Pemeriksaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `pendaftaran`
--
ALTER TABLE `pendaftaran`
  MODIFY `ID_Pendaftaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
...
--
ALTER TABLE `rekam_medis`
  MODIFY `ID_Rekam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `resep`
--
ALTER TABLE `resep`
  MODIFY `ID_Resep` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
