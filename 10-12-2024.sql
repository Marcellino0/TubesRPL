...
(1, 'dr.anton', '1234', 'dr. Anton', 'Umum', '', 100000.00),
...
(10, 'dr.abc', '1234', 'dr.abc', 'Umum', 'Senin-Jumat', 300000.00);
...
(48, 'Kenzhi', '0396816043106916', '2024-12-06', 'Laki-laki', 'user', '$2y$10$qmUOyqiksJyf8mHOV7K6xO67R0To12lV0Tf7oKPsToaaj9V4DG9a6', 'kenzhi@gmail.com', '12345678', 'Kopo', 'RM-2024-00001', 0, NULL, NULL, 'offline', '629439'),
...
(16, 163, '2024-12-10 13:57:39', 200000.00, 'QRIS', 'Belum Lunas'),
(17, 163, '2024-12-10 13:58:19', 200000.00, 'QRIS', 'Belum Lunas');
...
(73, 163, 3, '2024-12-10 13:47:08', 'sakit jiwa');
...
(163, 48, 6, '2024-12-10 00:00:00', 1, 'Selesai', NULL, 'Terverifikasi', '2024-12-10 13:45:57', '', 'online');
...
(38, 48, '120/80', 190.00, 67.00, 37.0, 'sakit jiwa', '2024-12-10');
...
(67, 73, 'Paracetamol - 500mg - 3x1 sehari setelah makan', '2024-12-10');
...
--
ALTER TABLE `pemeriksaan`
  MODIFY `ID_Pemeriksaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT for table `pendaftaran`
--
ALTER TABLE `pendaftaran`
  MODIFY `ID_Pendaftaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
...
--
ALTER TABLE `rekam_medis`
  MODIFY `ID_Rekam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `resep`
--
ALTER TABLE `resep`
  MODIFY `ID_Resep` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
